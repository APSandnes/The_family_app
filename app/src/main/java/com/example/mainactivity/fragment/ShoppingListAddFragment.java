...
public class ShoppingListAddFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tittel = view.findViewById(R.id.shopping_listTittel);
        opprett = view.findViewById(R.id.lagShoppingList);

        // Lager shopping_list dersom man har skrevet inn en tittel
        opprett.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(tittel.getText().toString().isEmpty()) {
                    Toast.makeText(getContext(), "Du må sette en tittel på shopping_list", Toast.LENGTH_SHORT).show();
                    Log.e("ShoppingListAdd", "Brukeren satte ikke en tittel på shopping_list");
                }
                else {
                    database.weekShoppingList(tittel.getText().toString(), meID);
                    ...
                    Log.i("ShoppingListAdd", "Tittel til shopping_list opprettet");
                }
            }
        });
    }
