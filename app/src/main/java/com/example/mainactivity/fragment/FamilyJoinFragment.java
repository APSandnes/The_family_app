...
public class FamilyJoinFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_family_join, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        familyID = view.findViewById(R.id.family_join_familieID);
        password = view.findViewById(R.id.family_join_passord);
        bliMedlemBtn = view.findViewById(R.id.family_join_BliMedlemBtn);
        ...
        bliMedlemBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (sjekkOmFamilyEksisterer()) {
                    ...
                    Toast.makeText(getActivity(), "Family id eller passord er feil", Toast.LENGTH_SHORT).show();
                    Log.e("FamilyJoinFragmen", "Family id eller passord er feil");
                }
            }
        });
    }

    private boolean sjekkOmFamilyEksisterer() {
        boolean familieEksisterer = false;

        Cursor bliMedlemAvFamily = database.sjekkOmFamilyEksisterer(familyID.getText().toString(), password.getText().toString());

        while(bliMedlemAvFamily.moveToNext()) {
            familyId = Integer.parseInt(bliMedlemAvFamily.getString(0));
            familieEksisterer = true;
        }
        Log.e("FamilyJoinFragmen", "Family eksisterer:" + familieEksisterer);
